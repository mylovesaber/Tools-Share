...
CFLAGS="-I/opt/project/redis/deps/usr/include:/opt/headers/usr/include" \
...
echo "rootsbindir=/opt/project/deps/usr/sbin" >configparms

CFLAGS="-I/opt/project/deps/usr/include:/opt/headers/usr/include" \
LDFLAGS="-Wl,--rpath=/opt/project/deps/usr/lib" \
../configure --prefix=/opt/project/deps/usr \
--disable-werror \
--enable-kernel=4.14 \
--enable-stack-protector=strong \
--enable-static-nss \
libc_cv_slibdir=/opt/project/deps/usr/lib
make -j$(nproc)
make install
make localedata/install-locales -j$(nproc)
...
#########################################################################################
# Zlib-1.3
tar xfv zlib-1.3.tar.xz
cd zlib-1.3
make distclean
CFLAGS="-I/opt/project/deps/usr/include" \
LDFLAGS="-L/opt/project/deps/usr/lib -Wl,--rpath=/opt/project/deps/usr/lib -Wl,--dynamic-linker=/opt/project/deps/usr/bin/ld.so" \
./configure \
...
make -j$(nproc) \
    ...
    LDFLAGS="-fPIC -L/opt/project/deps/usr/lib -Wl,--rpath=/opt/project/deps/usr/lib -Wl,--dynamic-linker=/opt/project/deps/usr/bin/ld.so -shared"
...
https://github.com/mesonbuild/meson/issues/969
# 静态构建
# 不能用--dynamic-linker
# https://stackoverflow.com/questions/69890574/how-to-add-a-linker-command-line-option-into-meson

LDFLAGS="-L/opt/project/deps/usr/lib -Wl,--rpath=/opt/project/deps/usr/lib" \
meson setup \
  -Dprefix=/home/build/zstd \
  -Dlibdir=/home/build/zstd/lib \
...
ninja -C build-static install
  ...
  -Dtest_rpath \
  -Dadd_global_link_arguments='-Wl,--rpath=/opt/project/deps/usr/lib -Wl,--dynamic-linker=/opt/project/deps/usr/bin/ld.so' \
zstd_header_dir = '/opt/slate/include'

zstd_header_dir = '/opt/project/deps/usr/include'
zstd_lib_dir = '/opt/project/deps/usr/lib'
zstd_modify_dep = declare_dependency(
    link_args : ['-L' + zstd_lib_dir],
    include_directories : include_directories(zstd_header_dir))

executable('zstd',
       build_rpath : zstd_lib_dir,
       install_rpath : zstd_lib_dir,
       dependencies : [zstd_modify_dep])
#########################################################################################
# Libcap-2.69
tar xfv libcap-2.69.tar.xz
cd libcap-2.69
make distclean
...
echo -e "/opt/project/deps/usr/bin/ld.so" | tr -d '\n' > libcap/loader.txt
...
make -j$(nproc) \
prefix=/opt/project/deps/usr lib=lib SHARED=no BUILD_LD="gcc -Wl,-x -static" \
...
make prefix=/opt/project/deps/usr lib=lib install-static



# 对照组(个别库需要安装到构建时指定的路径下才可以编译)
make prefix=/home/build/libcap/usr lib=lib install-static
...
LDFLAGS="-L/opt/project/deps/usr/lib -Wl,--rpath=/opt/project/deps/usr/lib -Wl,--dynamic-linker=/opt/project/deps/usr/bin/ld.so" \
CFLAGS="-I/opt/project/deps/usr/include" \
LDFLAGS="-L/opt/project/deps/usr/lib" \
...
# 对照组
make MANSUFFIX=ssl DESTDIR=/home/build/openssl install_sw
...
meson setup \
      ...
      -Dbindir=/opt/project/deps/usr/bin,/usr/bin \
      -Dlibdir=/opt/project/deps/usr/lib \
      -Dincludedir=/opt/project/deps/usr/include \
      -Db_staticpic=true \
      -Db_pie=true \
      build
# meson 单独构建库文件有两种写法
...
# 静态
# 这里制作出来的.a静态库其实是存放的是实际.o文件的地址，需要ar打包
ninja -C build version.h
ninja -C build libsystemd.a
ar -t libsystemd.a|xargs ar rvs newlibsystemd.a
cp -p build/{libsystemd.so,libsystemd.so.0,"${soName}",libsystemd.a} /opt/project/deps/usr/lib
...
# 尝试新的libsytemd静态编译方式，这种方式能制作出完整的静态库
meson build -Ddefault_library=static -Dprefer_static=true -Dstatic-libsystemd=true
ninja -C build libsystemd.a


#redis报错信息：
#    LINK redis-server
#/usr/bin/ld: /tmp/ccUm0BVr.ltrans21.ltrans.o: in function `moduleLoad':
#/home/build/rpmbuild/BUILD/redis-7.2.1/src/module.c:12133: warning: Using 'dlopen' in statically linked applications requires at runtime the shared libraries from the glibc version used for linking
#/usr/bin/ld: /opt/project/deps/usr/lib/libsystemd.a(src_basic_capability-util.c.o): in function `cap_freep':
#/home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.h:35: undefined reference to `cap_free'
#/usr/bin/ld: /opt/project/deps/usr/lib/libsystemd.a(src_basic_capability-util.c.o): in function `have_effective_cap':
#/home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:25: undefined reference to `cap_get_proc'
#/usr/bin/ld: /home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:29: undefined reference to `cap_get_flag'
#/usr/bin/ld: /opt/project/deps/usr/lib/libsystemd.a(src_basic_capability-util.c.o): in function `capability_update_inherited_set':
#/home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:99: undefined reference to `cap_set_flag'
#/usr/bin/ld: /opt/project/deps/usr/lib/libsystemd.a(src_basic_capability-util.c.o): in function `capability_ambient_set_apply':
#/home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:131: undefined reference to `cap_get_proc'
#/usr/bin/ld: /home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:139: undefined reference to `cap_set_proc'
#/usr/bin/ld: /opt/project/deps/usr/lib/libsystemd.a(src_basic_capability-util.c.o): in function `capability_gain_cap_setpcap':
#/home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:170: undefined reference to `cap_get_proc'
#/usr/bin/ld: /home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:174: undefined reference to `cap_get_flag'
#/usr/bin/ld: /home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:181: undefined reference to `cap_dup'
#/usr/bin/ld: /home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:185: undefined reference to `cap_set_flag'
#/usr/bin/ld: /home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:188: undefined reference to `cap_set_proc'
#/usr/bin/ld: /opt/project/deps/usr/lib/libsystemd.a(src_basic_capability-util.c.o): in function `capability_bounding_set_drop':
#/home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:214: undefined reference to `cap_dup'
#/usr/bin/ld: /home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:239: undefined reference to `cap_set_flag'
#/usr/bin/ld: /home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:247: undefined reference to `cap_set_flag'
#/usr/bin/ld: /home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:248: undefined reference to `cap_set_flag'
#/usr/bin/ld: /home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:258: undefined reference to `cap_set_proc'
#/usr/bin/ld: /home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:260: undefined reference to `cap_compare'
#/usr/bin/ld: /opt/project/deps/usr/lib/libsystemd.a(src_basic_capability-util.c.o): in function `drop_privileges':
#/home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:346: undefined reference to `cap_init'
#/usr/bin/ld: /home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:359: undefined reference to `cap_set_flag'
#/usr/bin/ld: /home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:360: undefined reference to `cap_set_flag'
#/usr/bin/ld: /home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:363: undefined reference to `cap_set_proc'
#/usr/bin/ld: /opt/project/deps/usr/lib/libsystemd.a(src_basic_capability-util.c.o): in function `drop_capability':
#/home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:373: undefined reference to `cap_get_proc'
#/usr/bin/ld: /home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:377: undefined reference to `cap_set_flag'
#/usr/bin/ld: /home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:378: undefined reference to `cap_set_flag'
#/usr/bin/ld: /home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:379: undefined reference to `cap_set_flag'
#/usr/bin/ld: /home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:382: undefined reference to `cap_set_proc'
#/usr/bin/ld: /opt/project/deps/usr/lib/libsystemd.a(src_basic_capability-util.c.o): in function `capability_quintet_enforce':
#/home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:446: undefined reference to `cap_get_proc'
#/usr/bin/ld: /home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:460: undefined reference to `cap_get_flag'
#/usr/bin/ld: /home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:462: undefined reference to `cap_get_flag'
#/usr/bin/ld: /home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:468: undefined reference to `cap_set_flag'
#/usr/bin/ld: /home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:470: undefined reference to `cap_set_flag'
#/usr/bin/ld: /home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:477: undefined reference to `cap_set_proc'
#/usr/bin/ld: /home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:489: undefined reference to `cap_get_proc'
#/usr/bin/ld: /home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:501: undefined reference to `cap_get_flag'
#/usr/bin/ld: /home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:516: undefined reference to `cap_set_flag'
#/usr/bin/ld: /home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:524: undefined reference to `cap_get_flag'
#/usr/bin/ld: /home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:536: undefined reference to `cap_set_flag'
#/usr/bin/ld: /home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:544: undefined reference to `cap_get_flag'
#/usr/bin/ld: /home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:556: undefined reference to `cap_set_flag'
#/usr/bin/ld: /home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:568: undefined reference to `cap_dup'
#/usr/bin/ld: /home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:572: undefined reference to `cap_set_flag'
#/usr/bin/ld: /home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:574: undefined reference to `cap_set_flag'
#/usr/bin/ld: /home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:577: undefined reference to `cap_compare'
#/usr/bin/ld: /home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:579: undefined reference to `cap_free'
#/usr/bin/ld: /home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:588: undefined reference to `cap_set_proc'
#/usr/bin/ld: /home/build/rpmbuild/BUILD/systemd-254/build/../src/basic/capability-util.c:604: undefined reference to `cap_set_proc'
#collect2: error: ld returned 1 exit status
#make[1]: *** [Makefile:403: redis-server] Error 1
#make[1]: Leaving directory '/home/build/rpmbuild/BUILD/redis-7.2.1/src'
...
make -j$(nproc) \
    ...
    USE_WERROR=0 \
    OPENSSL_PREFIX=/opt/project/deps/usr \
    CFLAGS="-I/opt/project/redis/deps/usr/include -I/home/build/sources/redis-stable/deps/jemalloc/include -static -fPIC" \
    LDFLAGS="-L/opt/project/redis/deps/usr/lib -static"\
    1>normal.log 2>error.log
 \
     EXEEXT="-static"

make CFLAGS="-I/home/build/rpmbuild/BUILD/redis-7.2.1/deps/jemalloc/include -static -L/opt/project/deps/usr/lib -Wl,--no-undefined" EXEEXT="-static" LDFLAGS="-L/opt/project/deps/usr/lib -Wl,--rpath=/opt/project/deps/usr/lib -Wl,--no-undefined -static"

make CFLAGS="-static" EXEEXT="-static" LDFLAGS="-static" MALLOC=jemalloc
...
make -j$(nproc) \
    ...
    CFLAGS="-static" \
     EXEEXT="-static" \
    LDFLAGS="-I/opt/project/redis/deps/usr/include -I/home/build/sources/redis-stable/deps/jemalloc/include -L/opt/project/redis/deps/usr/lib"
